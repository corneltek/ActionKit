...
$.extend($.facebox,{settings:{opacity:0.2,overlay:true,loadingImage:'/ph/plugins/Facebox/facebox/src/loading.gif',closeImage:'/ph/plugins/Facebox/facebox/src/closelabel.png',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
...
return true})
$(document).trigger('loading.facebox')},reveal:function(data,arg){var klass,cb;if(typeof arg=="string")klass=arg;else if(typeof arg=="function")cb=arg;$(document).trigger('beforeReveal.facebox')
...
if(cb)cb($('#facebox .content'));},close:function(){$(document).trigger('close.facebox')
return false}})
